...
//go:generate minimock -i homework-1/loms/internal/repository/stock.StockInterface -o stock_interface_mock.go -n StockInterfaceMock -p mock
...
type StockInterfaceMock struct {
	...
	funcReserve          func(ctx context.Context, sku uint32, count uint16) (b1 bool, err error)
...
func (mmReserve *mStockInterfaceMockReserve) Return(b1 bool, err error) *StockInterfaceMock {
	if mmReserve.mock.funcReserve != nil {
		mmReserve.mock.t.Fatalf("StockInterfaceMock.Reserve mock is already set by Set")
	}
	...
	mmReserve.defaultExpectation.results = &StockInterfaceMockReserveResults{b1, err}
...
func (mmReserve *mStockInterfaceMockReserve) Set(f func(ctx context.Context, sku uint32, count uint16) (b1 bool, err error)) *StockInterfaceMock {
	if mmReserve.defaultExpectation != nil {
...
func (e *StockInterfaceMockReserveExpectation) Then(b1 bool, err error) *StockInterfaceMock {
	e.results = &StockInterfaceMockReserveResults{b1, err}
	return e.mock
}
...
func (mmReserve *StockInterfaceMock) Reserve(ctx context.Context, sku uint32, count uint16) (b1 bool, err error) {
