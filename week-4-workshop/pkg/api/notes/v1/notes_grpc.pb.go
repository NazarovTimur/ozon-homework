...
func (c *notesClient) SaveNote(ctx context.Context, in *SaveNoteRequest, opts ...grpc.CallOption) (*SaveNoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes/SaveNote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notesClient) ListNotes(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListNotesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes/ListNotes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notesClient) GetNoteByID(ctx context.Context, in *GetNoteByIDRequest, opts ...grpc.CallOption) (*GetNoteByIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes/GetNoteByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notesClient) DeleteNoteByID(ctx context.Context, in *DeleteNoteByIDRequest, opts ...grpc.CallOption) (*DeleteNoteByIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes/DeleteNoteByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notesClient) UpdateNoteByID(ctx context.Context, in *UpdateNoteByIDRequest, opts ...grpc.CallOption) (*UpdateNoteByIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes/UpdateNoteByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Notes_SaveNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes/SaveNote",
	}
...
func _Notes_ListNotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes/ListNotes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Notes_GetNoteByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes/GetNoteByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Notes_DeleteNoteByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes/DeleteNoteByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Notes_UpdateNoteByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes/UpdateNoteByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Notes_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gitlab.ozon.dev.go.classroom_13.students.workshop_3.pkg.notes.v1.Notes",
